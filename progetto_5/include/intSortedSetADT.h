...
_Bool sset_subseteq(const IntSortedSetADT,
                    const IntSortedSetADT); // controlla se il primo insieme e' incluso nel secondo

_Bool sset_subset(const IntSortedSetADT,
                  const IntSortedSetADT); // contr. se il primo ins. e' incluso strettamente nel secondo

IntSortedSetADT sset_union(const IntSortedSetADT,
                           const IntSortedSetADT); // restituisce l'unione di due insiemi

IntSortedSetADT sset_intersection(const IntSortedSetADT,
                                  const IntSortedSetADT); // restituisce l'intersezione di due insiemi

IntSortedSetADT sset_subtraction(const IntSortedSetADT,
                                 const IntSortedSetADT); // restituisce l’insieme ottenuto dal primo togliendo gli elementi del secondo
